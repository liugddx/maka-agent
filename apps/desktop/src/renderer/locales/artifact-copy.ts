...
const ARTIFACT_COPY = {
  zh: {
    pane: {
      ...
      openInFinder: '在 Finder 中打开', saveAs: '另存为', copy: '复制', runtimeArchiveReadOnly: '运行时归档是只读执行证据，不能从这里删除',
  ...
  en: {
    pane: {
      ...
      openInFinder: 'Show in Finder', saveAs: 'Save as', copy: 'Copy', runtimeArchiveReadOnly: 'Runtime archives are read-only execution evidence and cannot be deleted here',
